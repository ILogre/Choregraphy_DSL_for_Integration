...
/**
 * This is the item provider adapter for a {@link integration.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Operation_name_feature",
								"_UI_Operation_type"),
						IntegrationPackage.Literals.OPERATION__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Operation_args_feature",
								"_UI_Operation_type"),
						IntegrationPackage.Literals.OPERATION__ARGS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Operation_sideEffect_feature",
								"_UI_Operation_type"),
						IntegrationPackage.Literals.OPERATION__SIDE_EFFECT, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Operation_invokingMsg_feature",
								"_UI_Operation_type"),
						IntegrationPackage.Literals.OPERATION__INVOKING_MSG, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Operation_answeringMsg_feature",
								"_UI_Operation_type"),
						IntegrationPackage.Literals.OPERATION__ANSWERING_MSG, true, false, true, null, null, null));
	}

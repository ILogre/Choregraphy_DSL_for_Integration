...
/**
 * This is the item provider adapter for a {@link chor4integration.FlowNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FlowNode_incomings_feature",
								"_UI_FlowNode_type"),
						Chor4integrationPackage.Literals.FLOW_NODE__INCOMINGS, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FlowNode_outgoings_feature",
								"_UI_FlowNode_type"),
						Chor4integrationPackage.Literals.FLOW_NODE__OUTGOINGS, true, false, true, null, null, null));
	}

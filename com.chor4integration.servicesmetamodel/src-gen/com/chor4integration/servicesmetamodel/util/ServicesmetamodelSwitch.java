 ...
 * @generated
 */
public class ServicesmetamodelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ServicesmetamodelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ServicesmetamodelPackage.USER: {
			...
			if (result == null)
				result = caseActor(user);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ServicesmetamodelPackage.ACTOR: {

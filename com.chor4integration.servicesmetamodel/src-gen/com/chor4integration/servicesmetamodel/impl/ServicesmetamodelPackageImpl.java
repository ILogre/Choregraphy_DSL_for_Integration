...
public class ServicesmetamodelPackageImpl extends EPackageImpl implements ServicesmetamodelPackage {
	 ...
	 * @see com.chor4integration.servicesmetamodel.ServicesmetamodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ServicesmetamodelPackageImpl() {
		super(eNS_URI, ServicesmetamodelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ServicesmetamodelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ServicesmetamodelPackage init() {
		if (isInited)
			return (ServicesmetamodelPackage) EPackage.Registry.INSTANCE.getEPackage(ServicesmetamodelPackage.eNS_URI);

		// Obtain or create and register package
		ServicesmetamodelPackageImpl theServicesmetamodelPackage = (ServicesmetamodelPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ServicesmetamodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new ServicesmetamodelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theServicesmetamodelPackage.createPackageContents();

		// Initialize created meta-data
		theServicesmetamodelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theServicesmetamodelPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ServicesmetamodelPackage.eNS_URI, theServicesmetamodelPackage);
		return theServicesmetamodelPackage;
	}

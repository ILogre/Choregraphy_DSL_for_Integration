 ...
 * @generated
 */
public class Chor4intSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Chor4intPackage modelPackage;
	 ...
	 * @generated
	 */
	public Chor4intSwitch() {
		if (modelPackage == null) {
			modelPackage = Chor4intPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Chor4intPackage.FLOW_ELEMENT: {
		...
		case Chor4intPackage.FLOW_NODE: {
		...
		case Chor4intPackage.INTERACTION: {

 ...
 * @generated
 */
public class Chor4intPackageImpl extends EPackageImpl implements Chor4intPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.chor4integration.chor4int.Chor4intPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Chor4intPackageImpl() {
		super(eNS_URI, Chor4intFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Chor4intPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Chor4intPackage init() {
		if (isInited)
			return (Chor4intPackage) EPackage.Registry.INSTANCE.getEPackage(Chor4intPackage.eNS_URI);

		// Obtain or create and register package
		Chor4intPackageImpl theChor4intPackage = (Chor4intPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof Chor4intPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new Chor4intPackageImpl());
		...
		theChor4intPackage.createPackageContents();

		// Initialize created meta-data
		theChor4intPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theChor4intPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Chor4intPackage.eNS_URI, theChor4intPackage);
		return theChor4intPackage;
	}
	 ...
	 * @generated
	 */
	public Chor4intFactory getChor4intFactory() {
		return (Chor4intFactory) getEFactoryInstance();
	}

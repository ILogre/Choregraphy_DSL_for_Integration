...
public class IntegrationFactoryImpl extends EFactoryImpl implements IntegrationFactory {
	...
	public static IntegrationFactory init() {
		try {
			IntegrationFactory theIntegrationFactory = (IntegrationFactory) EPackage.Registry.INSTANCE
					.getEFactory(IntegrationPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case IntegrationPackage.ROLE:
			return createRole();
		case IntegrationPackage.SERVICE:
			return createService();
		case IntegrationPackage.STRUCTURAL_VIEW:
			return createStructuralView();
		case IntegrationPackage.OPERATION:
			return createOperation();
		case IntegrationPackage.MESSAGE:
			return createMessage();
		case IntegrationPackage.USER:
			return createUser();
		default:

 ...
 * </p>
 * <ul>
 *   <li>{@link chor4integration.impl.FlowNodeImpl#getIncomings <em>Incomings</em>}</li>
 *   <li>{@link chor4integration.impl.FlowNodeImpl#getOutgoings <em>Outgoings</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FlowNodeImpl extends FlowElementImpl implements FlowNode {
	...
	protected EClass eStaticClass() {
		return Chor4integrationPackage.Literals.FLOW_NODE;
	}
	...
	public EList<SequenceFlow> getIncomings() {
		if (incomings == null) {
			incomings = new EObjectWithInverseResolvingEList<SequenceFlow>(SequenceFlow.class, this,
					Chor4integrationPackage.FLOW_NODE__INCOMINGS, Chor4integrationPackage.SEQUENCE_FLOW__TARGET);
		}
		return incomings;
	}
	...
	public EList<SequenceFlow> getOutgoings() {
		if (outgoings == null) {
			outgoings = new EObjectWithInverseResolvingEList<SequenceFlow>(SequenceFlow.class, this,
					Chor4integrationPackage.FLOW_NODE__OUTGOINGS, Chor4integrationPackage.SEQUENCE_FLOW__SOURCE);
		}
		return outgoings;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Chor4integrationPackage.FLOW_NODE__INCOMINGS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getIncomings()).basicAdd(otherEnd, msgs);
		case Chor4integrationPackage.FLOW_NODE__OUTGOINGS:

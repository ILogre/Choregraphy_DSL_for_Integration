 ...
 * </p>
 * <ul>
 *   <li>{@link chor4integration.impl.AtomicInteractionImpl#getTargetOperation <em>Target Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AtomicInteractionImpl extends InteractionImpl implements AtomicInteraction {
	...
	protected EClass eStaticClass() {
		return Chor4integrationPackage.Literals.ATOMIC_INTERACTION;
	}
			...
			if (targetOperation != oldTargetOperation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Chor4integrationPackage.ATOMIC_INTERACTION__TARGET_OPERATION, oldTargetOperation,
							targetOperation));
			}
		}
	...
	public void setTargetOperation(Operation newTargetOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Chor4integrationPackage.ATOMIC_INTERACTION__TARGET_OPERATION, oldTargetOperation, targetOperation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Chor4integrationPackage.ATOMIC_INTERACTION__TARGET_OPERATION:
			if (resolve)
